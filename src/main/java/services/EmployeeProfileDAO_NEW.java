...
public final class EmployeeProfileDAO_NEW {
	...
	private static final String AD_STERIA_PRINCIPAL = new StringBuilder("cn=")
																.append(AD_STERIA_USERNAME)
																.append(",")
	...
	public static String findEmployeeFullNameFromEmailAddress(String email) throws NamingException, InvalidAttributeValueException{
		...
		try (final ADConnection_NEW connection = new ADConnection_NEW(SOPRA_ENVIRONMENT_SETTINGS)) {
			...
			final String fullName = new StringBuilder(forename)
					.append(" ")
					.append(surname.substring(0, 1).toUpperCase())
					.append(surname.substring(1))
					.toString();
