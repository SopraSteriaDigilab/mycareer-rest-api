...
public class HRDataDAO {
	...
	public static long getTotalUsersWithObjectives() {
		...
		long totalUsersWithObjectives = dbConnection.find(Employee.class).field("objectives").exists()
				.countAll();
	...
	public static long getTotalUsersWithDevelopmentNeeds() {
		...
		long totalUsersWithDevelopmentNeeds = dbConnection.find(Employee.class).field("developmentNeeds")
				.exists().countAll();
	...
	public static long getTotalUsersWithCompetencies() {
		...
		long totalUsersWithCompetencies = dbConnection.find(Employee.class).field("competencies").exists()
				.countAll();
	...
	public static long getTotalUsersWithFeedback() {
		...
		long totalUsersWithFeedback = dbConnection.find(Employee.class).field("feedback").exists()
				.countAll();
