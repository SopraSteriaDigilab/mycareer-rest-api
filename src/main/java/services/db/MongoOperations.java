 ...
 * 
 * This class should be used for any CRUD operations using the the Mongo Java
 * driver.
 *
 */
public class MongoOperations {
	...
	/**
	 * Collection enum. Represents the different collections on the Development
	 * database.
	 *
	 */
	...
	/**
	 * Performs an aggregation using the given pipeline and returns the results
	 * as a List.
	 *
	 * @param aggregationStages
	...
	/**
	 * Method that returns an List of all the values of a given field in the
	 * database. This method assumes the field is a list in the database
	 *
	 * @param key
	 *            The new key value of the field
	 * @param reference
	 *            The reference field in the database
	 * @return An List<T> of the results.
	 */
	public <T> Set<T> getFieldValuesAsSet(String listName, String... fieldNames) {
		final Document fieldsToArray = projectFieldsToArray(listName, fieldNames);
		final Document unwindListName = unwind(listName);
		final List<Document> aggregationQuery = Arrays.asList(fieldsToArray, unwindListName);
		final AggregateIterable<Document> rawResults = mongoCollection.aggregate(aggregationQuery);
	...
	/**
	 * Method to add to either the Objectives or Development Needs history
	 * collections. Upsert is set to true.
	 *
	 * @param find
	 *            The filter of _id document to match
	 * @param update
	 *            The update to store
	 */
	...
	/**
	 * Performs an update of a single document using the given filter, setting
	 * the field/value pairs in keyValuePairs.
	 *
	 * @param bson
	 *            the filter to find the document to update
	 * @param keyValuePairs
	 *            a document representing zero or more fields to update in the
	...
	/**
	 * Creates an Document that represents the _id field in the objectives
	 * history collections.
	 *
	 * @param employeeId
	 *            The employee id
	...
	/**
	 * Creates an Document that represents the _id field in the development
	 * needs history collections.
	 *
	 * @param employeeId
	 *            The employee id
	 * @param objectiveID
