...
public class Note_NEW
{
  ...
  private static final String ERROR_NOTE_EMPTY = "Note feild can not be empty.";
  ...
  @NotNull(message = ERROR_NOTE_EMPTY)
  @NotBlank(message = ERROR_NOTE_EMPTY)
  @Size(min = 1, max = 1000, message = ERROR_NOTE_DESCRIPTION_LIMIT)
