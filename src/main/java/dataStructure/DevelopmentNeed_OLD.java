...
public class DevelopmentNeed_OLD implements Serializable
{
  ...
  public DevelopmentNeed_OLD(int id, int progress, int cat, String title, String description)
  ...
  // Constructor with parameters
  public DevelopmentNeed_OLD(int id, int progress, int cat, String title, String description, String completeBy)
      throws InvalidAttributeValueException
  {
    this.setID(id);
    this.setProgress(progress);
  ...
  public DevelopmentNeed_OLD(DevelopmentNeed_OLD devNeed) throws InvalidAttributeValueException
  {
