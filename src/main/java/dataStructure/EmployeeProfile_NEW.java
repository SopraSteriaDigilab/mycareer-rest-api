...
public class EmployeeProfile_NEW implements Serializable
{
  ...
  public EmployeeProfile_NEW(long employeeID, String guid, String name, String surname, String emailAddress,
      String username, String company, String team, boolean isManager, List<String> reps)
