 ...
 * @deprecated as of January 2016. Use {@linkplain dataStructure.FeedbackRequest FeedbackRequest}
 * 
 * This class contains the definition of the FeedbackRequest object
 *
 */
@Embedded
public class FeedbackRequestOLD implements Serializable{//, Iterable<Feedback> {
...
//		replies=new ArrayList<Feedback>();
	...
	public FeedbackRequestOLD(long id){
		this.setTimeStamp();
		this.generateID(id);
		this.recipient="";
		this.setRepliedTo(false);
//		replies=new ArrayList<Feedback>();
	...
	public FeedbackRequestOLD(String feedbackID, String recipient){
	...
	public FeedbackRequestOLD(long id, String recipient) throws InvalidAttributeValueException{
		this.setTimeStamp();
		this.generateID(id);
	...
	public FeedbackRequestOLD(FeedbackRequestOLD req){
