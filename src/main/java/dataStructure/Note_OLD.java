 ...
 * @deprecated Use {@linkplain Note Note } instead
 */
@Embedded
public class Note_OLD implements Serializable
{
  ...
  public Note_OLD(int id, int noteType, int linkID, String body, String from) throws InvalidAttributeValueException
  {
    this.setID(id);
