...
public class EmployeeProfileTest
{
  ...
  public void setup() throws InvalidAttributeValueException
  {
    ...
    unitUnderTest = new EmployeeProfile.Builder().employeeID(VALID_EMPLOYEE_ID).forename(VALID_NAME).surname(VALID_NAME)
        ...
        .manager(IS_MANAGER).hasHRDash(HAS_HRDASH).reporteeCNs(new ArrayList<>(VALID_REPORTEE_LIST)).build();
    initMocks(this);
  }
  ...
  {
    unitUnderTest.setEmailAddresses(null);
  }
  ...
  {
    unitUnderTest.setEmailAddresses(new HashSet<>());
  }
  ...
  public void testSetEmailAddressWithInvalidEmailAddress() throws InvalidAttributeValueException
  {
    ...
    unitUnderTest.setEmailAddresses(emailAddresses);
  }
  ...
  public void testSetEmailAddressWithValidEmailAddress() throws InvalidAttributeValueException
  {
    Set<String> emailAddresses = new HashSet<>();
    emailAddresses.add(VALID_EMAIL_ADDRESS);
    assertEquals(unitUnderTest.getEmailAddresses(), emailAddresses);
  }
   ...
   */
  @Test
  public void testAddReporteeCheckIfReporteeCNsIsNull() throws InvalidAttributeValueException, IllegalArgumentException,
  ...
  {
    assertEquals(unitUnderTest.toString(),
        "EmployeeProfile [employeeID=" + unitUnderTest.getEmployeeID() + ", surname=" + unitUnderTest.getSurname()
            + ", forename=" + unitUnderTest.getForename() + ", username=" + unitUnderTest.getUsername()
            + ", emailAddress=" + unitUnderTest.getEmailAddresses() + ", isManager=" + unitUnderTest.getIsManager()
            + ", company=" + unitUnderTest.getCompany() + ", steriaDepartment=" + unitUnderTest.getSteriaDepartment()
            + ", sector=" + unitUnderTest.getSector() + ", superSector=" + unitUnderTest.getSuperSector()
            + ", reporteeCNs=" + unitUnderTest.getReporteeCNs() + "]");
  }
}