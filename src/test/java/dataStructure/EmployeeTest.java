...
//    LOG.debug("AppControllerTest.setup()", true);
    adProfileAdvanced = new ADProfile_Advanced(VALID_EMPLOYEE_ID, VALID_STRING, VALID_STRING, VALID_STRING, VALID_EMAIL, VALID_STRING, VALID_STRING, VALID_STRING, VALID_EMAIL, VALID_EMAIL, VALID_EMAIL, VALID_EMAIL, false, false, VALID_REPORTEE_LIST);
